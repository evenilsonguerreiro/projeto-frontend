...
const Hero = () => {
  ...
  const proximo = () =>
    setAtual(atual === imagensSlide.length - 1 ? 0 : atual + 1);
  const anterior = () =>
    setAtual(atual === 0 ? imagensSlide.length - 1 : atual - 1);
      ...
      <HeroContent>
        <HeroTexto>
          ...
          <p className="description">
            Consequat culpa exercitante mollit nisi excepteur do do tempor
